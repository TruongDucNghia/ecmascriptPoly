const footer = {
    render(){
        return /*html*/ `
        <footer style="background-color: #272f54; color:#fff"  class=" mt-8 px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center items-center space-x-3 lg:justify-start">
				<img src="https://phothongcaodang.fpt.edu.vn/wp-content/uploads/LOGO-PTC%C4%90-White-Transparency.png" alt="" width="200px">
			</a>
		</div>
